...
alter table alerts add constraint fk_alerts_route_1 foreign key (route_route_id) references routes (route_id);
create index ix_alerts_route_1 on alerts (route_route_id);
alter table routes add constraint fk_routes_agency_2 foreign key (agency_id) references agencies (id);
create index ix_routes_agency_2 on routes (agency_id);
